...
// modified bufferlen (divide by 1) to update "row" value more often, else some value may be skipped
// remove all filters (useless?)
...
Modplayer.prototype.createContext = function()
{
  ...
  // patch up some cables :)  modified to remove all filters

...
/**
 * Tear down the current ScriptProcessorNode and rebuild it on a
 * (possibly new) AudioContext.  Called from a user gesture to force
 * mobile browsers to actually produce audible output.
 */

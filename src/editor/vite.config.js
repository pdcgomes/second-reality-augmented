...
#sound-btn{display:none;position:fixed;bottom:16px;right:14px;z-index:5;width:44px;height:44px;border:1px solid rgba(255,255,255,.2);border-radius:50%;background:rgba(0,0,0,.5);color:rgba(255,255,255,.6);cursor:pointer;-webkit-tap-highlight-color:transparent;align-items:center;justify-content:center}
#sound-btn:active{background:rgba(255,255,255,.15)}
#sound-btn svg{width:20px;height:20px;fill:currentColor}
#scrub-bar{display:none;position:fixed;bottom:0;left:0;right:0;height:3px;background:rgba(255,255,255,.08);z-index:6}
#scrub-bar.active{height:5px;background:rgba(255,255,255,.15)}
#scrub-fill{height:100%;width:0;background:rgba(255,255,255,.25);transition:none}
#scrub-bar.active #scrub-fill{background:rgba(255,255,255,.55)}
#scrub-time{display:none;position:fixed;bottom:14px;left:50%;transform:translateX(-50%);font-family:'Courier New',monospace;font-size:13px;color:rgba(255,255,255,.7);z-index:6;pointer-events:none;white-space:nowrap}
</style>
</head>
<body>

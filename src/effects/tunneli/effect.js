/**
 * Tunneli (Dottitunneli) — Classic variant
 *
 * Dot-based tunnel effect with concentric circles receding into depth.
 * Uses atan2 for angle and 1/length for depth mapping.
 * Original source: TUNNELI/ folder in SecondReality repo (code by TRUG).
 */

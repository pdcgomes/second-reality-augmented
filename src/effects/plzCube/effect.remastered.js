...
// ── Palette presets (3 two-segment ramps per palette: lo → mid → hi) ──
...
const PALETTES = [
  ...
  { name: 'Gruvbox',     faces: [
    [[.16,.16,.16],[.408,.616,.416],[.922,.859,.698]],
    [[.16,.16,.16],[.839,.365,.055],[.843,.6,.129]],
    [[.16,.16,.16],[.694,.384,.525],[.596,.592,.102]],
  ]},
  { name: 'Monokai',     faces: [
    [[.15,.16,.13],[.4,.851,.937],[.973,.973,.949]],
    [[.15,.16,.13],[.976,.149,.447],[.992,.592,.122]],
    [[.15,.16,.13],[.682,.506,1],[.651,.886,.18]],
  ]},
  { name: 'Dracula',     faces: [
    [[.16,.165,.212],[.741,.576,.976],[1,.475,.776]],
    [[.16,.165,.212],[1,.333,.333],[1,.722,.424]],
    [[.16,.165,.212],[.545,.914,.992],[.314,.98,.482]],
  ]},
  { name: 'Solarized',   faces: [
    [[0,.169,.212],[.149,.545,.824],[.514,.58,.588]],
    [[0,.169,.212],[.863,.196,.184],[.71,.537,0]],
    [[0,.169,.212],[.827,.212,.51],[.522,.6,0]],
  ]},
  { name: 'Nord',        faces: [
    [[.18,.204,.251],[.533,.753,.816],[.847,.871,.914]],
    [[.18,.204,.251],[.749,.38,.416],[.816,.529,.439]],
    [[.18,.204,.251],[.706,.557,.678],[.639,.745,.549]],
  ]},
  { name: 'One Dark',    faces: [
    [[.157,.173,.204],[.38,.686,.937],[.671,.698,.749]],
    [[.157,.173,.204],[.878,.424,.459],[.898,.753,.482]],
    [[.157,.173,.204],[.776,.471,.867],[.596,.765,.475]],
  ]},
  { name: 'Catppuccin',  faces: [
    [[.118,.118,.18],[.537,.706,.98],[.706,.745,.996]],
    [[.118,.118,.18],[.953,.545,.659],[.98,.702,.529]],
    [[.118,.118,.18],[.796,.651,.969],[.651,.89,.631]],
  ]},
  { name: 'Tokyo Night', faces: [
    [[.102,.106,.149],[.478,.635,.969],[.663,.694,.839]],
    [[.102,.106,.149],[.969,.463,.557],[1,.62,.392]],
    [[.102,.106,.149],[.733,.604,.969],[.62,.808,.416]],
  ]},
  { name: 'Synthwave',  faces: [
    [[.149,.137,.208],[.212,.976,.961],[.447,.984,.722]],
    [[.149,.137,.208],[1,.494,.859],[.992,.871,.365]],
    [[.149,.137,.208],[.784,.573,.918],[.451,.976,.722]],
  ]},
  { name: 'Kanagawa',   faces: [
    [[.122,.122,.157],[.494,.612,.847],[.863,.843,.729]],
    [[.122,.122,.157],[.765,.251,.263],[1,.627,.4]],
    [[.122,.122,.157],[.592,.498,.722],[.463,.584,.416]],
  ]},
  { name: 'Everforest', faces: [
    [[.176,.208,.231],[.498,.733,.702],[.827,.776,.667]],
    [[.176,.208,.231],[.902,.494,.502],[.863,.596,.467]],
    [[.176,.208,.231],[.843,.6,.71],[.655,.753,.502]],
  ]},
  { name: 'Rose Pine',  faces: [
    [[.098,.09,.141],[.612,.812,.847],[.878,.835,.894]],
    [[.098,.09,.141],[.922,.435,.573],[.965,.757,.467]],
    [[.098,.09,.141],[.769,.655,.902],[.584,.737,.831]],
  ]},
];
...
uniform vec3 uPalLo[3];
uniform vec3 uPalMid[3];
uniform vec3 uPalHi[3];
...
void main() {
  float u = mix(64.0, 190.0, vUV.x);
  float v = mix(4.0, 60.0, vUV.y);
...
export default {
  ...
  params: [
    ...
    gp('Face A',  { key: 'hueA',     label: 'Hue Shift',  type: 'float', min: -180, max: 180, step: 1,  default: 0 }),
    gp('Face B',  { key: 'hueB',     label: 'Hue Shift',  type: 'float', min: -180, max: 180, step: 1,  default: 0 }),
  ...
  init(gl) {
    ...
    cu_ = {
      ...
      palLo:      gl.getUniformLocation(cubeProg, 'uPalLo'),
      palMid:     gl.getUniformLocation(cubeProg, 'uPalMid'),
      palHi:      gl.getUniformLocation(cubeProg, 'uPalHi'),
    };
  ...
  render(gl, t, beat, params) {
    ...
    gl.uniform3f(cu_.themeHue, p('hueA', 0), p('hueB', 0), p('hueC', 0));

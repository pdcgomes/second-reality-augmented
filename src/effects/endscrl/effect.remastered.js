/**
 * ENDSCRL — Remastered variant (Part 25)
 *
 * Same ending text scroller (greetings and credits) as the classic.
...
export default {
  ...
  destroy(gl) {
    ...
    rgba = upscaledRgba = fontData = fontCharWidth = fontCharXPos = fb640 = null;
  },
};

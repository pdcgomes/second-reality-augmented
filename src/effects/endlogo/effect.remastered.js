/**
 * ENDLOGO — Remastered variant (Part 23)
 *
 * Same end logo with fade-in from white, hold, and fade-out to black
 * as the classic. The remastered variant bilinear-upscales the 320×200
 * framebuffer 4× before upload and uses LINEAR texture filtering to
 * smooth pixel edges at high display resolutions.
 *
 * Original source: ENDLOGO/ folder in SecondReality repo.
 */
...
let rgba, upscaledRgba, basePal, pixels;

export default {
  label: 'endlogo (remastered)',
  params: [],
  ...
  destroy(gl) {
    ...
    rgba = upscaledRgba = basePal = pixels = null;
  },
};
